...
describe('SyncStatusIndicator', () => {
  ...
  describe('Visual States', () => {
    describe('Offline State', () => {
      ...
      it('should render offline state with gray cloud icon', () => {
        ...
        // Verify icon props
        const icon = UNSAFE_getByType('MaterialCommunityIcons' as React.ComponentType);
    ...
    describe('Syncing State', () => {
      ...
      it('should render syncing state with spinner', () => {
        ...
        const spinner = UNSAFE_getByType('ActivityIndicator' as React.ComponentType);
  ...
  describe('Real-time Updates', () => {
    ...
    it('should update when isSyncing changes', () => {
      ...
      rerender(<SyncStatusIndicator />);
      expect(getByText('Syncing...')).toBeTruthy();
      expect(UNSAFE_queryByType('ActivityIndicator' as React.ComponentType)).toBeTruthy();
    });
